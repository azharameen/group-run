...
2. Quantify endpoint response latencies (p50 and p95 distributions).
3. Validate concurrent event processing and queue stability.
4. Detect regressions early across backend API and frontend E2E layers.
...
2. Update `backend/tests/performance-baseline.md` with the new environment details, Python/Node versions, and recorded latencies.
...
- [`backend/tests/performance-baseline.md`](../backend/tests/performance-baseline.md) — Captured baseline measurements and metrics.
- [`docs/architecture.md`](architecture.md) — System architecture, event bus design, and persistence.
- [`docs/coding-guidelines.md`](coding-guidelines.md) — General testing and coding conventions.
