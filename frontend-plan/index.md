...
>
> **Superseded by**: [`architecture.md`](https://azharameen.github.io/group-run/architecture/index.md) (current structure), [`ui-design.md`](https://azharameen.github.io/group-run/ui-design/index.md) (component design), [`features.md`](https://azharameen.github.io/group-run/features/index.md) (feature inventory).
>
