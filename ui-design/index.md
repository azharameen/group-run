...
- [Architecture](https://azharameen.github.io/group-run/architecture/index.md) — System architecture and data flow
- [PRD](https://azharameen.github.io/group-run/prd/index.md) — Product requirements
- [Features](https://azharameen.github.io/group-run/features/index.md) — Feature tree
